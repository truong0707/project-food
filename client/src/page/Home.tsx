  ...
  return (
    <div>
      <div className="wrap_home">
        <img className="main_img" src="https://ideakreativa.net/wp-content/uploads/2019/11/diseno-menu-carta-restaurante.jpg" alt="main-img" />
        ...
        <div className="backdrop">
          ...
          <ul className="box_introduce" >
            <li className="first" >
              ...
              <p>"Mamuka" is a Georgian family restaurant created in the best traditions of southern hospitality.
                We tried to combine exquisite style, rich Georgian flavor and modern comfort level. And
                when delicious food is combined with quality service,
                you get a restaurant that you want to return to again.</p>

              <p  className="btn_more"><b>More about us</b></p>
            </li>

            <li className="second">
              <iframe src="https://www.youtube.com/embed/F3zw1Gvn4Mk" title="YouTube video player" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </li>
          </ul>
